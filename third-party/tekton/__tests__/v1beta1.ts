...
import { Pipeline } from "../gen/tekton.dev/v1beta1/Pipeline";
import { PipelineRun } from "../gen/tekton.dev/v1beta1/PipelineRun";
import { Task } from "../gen/tekton.dev/v1beta1/Task";
import { TaskRun } from "../gen/tekton.dev/v1beta1/TaskRun";
...
describe("Pipeline", () => {
  ...
  it("should set apiVersion", () => {
    expect(pipeline).toHaveProperty("apiVersion", "tekton.dev/v1beta1");
  });
...
describe("PipelineRun", () => {
  ...
  it("should set apiVersion", () => {
    expect(pipelineRun).toHaveProperty("apiVersion", "tekton.dev/v1beta1");
  });
...
describe("Task", () => {
  ...
  it("should set apiVersion", () => {
    expect(task).toHaveProperty("apiVersion", "tekton.dev/v1beta1");
  });
...
describe("TaskRun", () => {
  ...
  it("should set apiVersion", () => {
    expect(taskRun).toHaveProperty("apiVersion", "tekton.dev/v1beta1");
  });
